...
```
-- RFC 6298, §2; von Hippel (2025), p. 21
...
> congestion collapse.»*
> — von Hippel (2025), p. 11; цитата из RFC 6298 [21]
...
за действиями отправителя (non-interfering monitor, раздел 2.2, von Hippel (2025), p. 17).

### Алгоритм Карна — состояния и переходы

Алгоритм Карна описывается следующей логикой выборки RTT
(Алгоритм 1, von Hippel (2025), p. 19):
...
- **s11** (`timeout_risk`): патологический случай (Obs.6, p. 22–23): rttvar падает
...
Это соответствует Наблюдению 3 (von Hippel (2025), p. 20): алгоритм Карна всегда выдаёт реальный RTT
...
ложного таймаута (Наблюдение 6, von Hippel (2025), p. 22–23). Третьего исхода нет.
